...
type ScoreboardParamsV2 struct {
	Uid      string
	Game     []GameCorp
	Channels []ChannelsInfo
}
type GameCorp struct {
	GameCorporation   string
	GameCorporationId string
	ChannelWebhook    string
	Webhook           string
	LastMessageID     string
}
type ChannelsInfo struct {
	GuildChannelName string
...
type MultiAccount struct {
	...
	Data             *MultiAccountData `json:"data,omitempty"`
}
