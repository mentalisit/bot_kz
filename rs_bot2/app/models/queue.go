...
func (q *QueueActive) GetFullMap(mes map[string]QueueMessages) []byte {
...
type QueueData struct {
	CorporationUuid string        `json:"corporation_uuid"`
	GameCorporation string        `json:"game_corporation"`
	GamePercent     string        `json:"game_percent"`
	...
	MAcc            *MultiAccount `json:"m_acc,omitempty"`
}
