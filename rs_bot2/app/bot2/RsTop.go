...
func GetCorpAlias(config models.CorporationConfigV2) string {
	corpName := ""
	switch config.Uid {
...
func (b *Bot) Top(in *models.InMessageV2, rs *models.Rs) {
	...
	//}
	//
	//numEvent := b.storage.Event.NumActiveEvent(in.Config.Uid)
	//b.sendTextAfterDeleteSecond(in, b.getText(in, "scan_db"), 5)
	//
...
func (b *Bot) TopGame(in *models.InMessageV2, rs *models.Rs) {
	b.deleteInMessage(in)
