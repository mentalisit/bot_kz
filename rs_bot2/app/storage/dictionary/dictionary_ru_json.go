...
"info_cannot_click_plus":"рановато плюсик жмешь, ты в очереди на ",
"info_cannot_click_minus":"рановато минус жмешь, ты в очереди на ",
...
"info_bot_delete_msg_new":"ВНИМАНИЕ \nБОТ УДАЛЯЕТ СООБЩЕНИЯ ПОЛЬЗОВАТЕЛЕЙ ЧЕРЕЗ %d МИНУТ",
"information":"Справка",
