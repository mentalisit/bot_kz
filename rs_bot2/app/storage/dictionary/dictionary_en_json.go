...
"info_help_text":"Get in queue *(DRS level)+(waiting time)*:\n    **[7-11]+** or\n    **[7-11]+[specify timeout in minutes]**\n*Examples:*\n    **7+** to stand in a queue for a level 7 DRS\n    **8+30** to stand in a queue for a level 8 DRS, waiting time is not more than 30 minutes\nLeave queue:\n    **[7-11]-**\n*Example:*\n    **9-** to exit the queue 9 level DRS\nView list of active queues:\n    **q[7-11]**\n*Example:*\n    **q9** show the queue for your DRS\nGet DRS role:\n    **+[7-11]**\n*Examples:*\n    **+7** get a role for DRS level 7\n    **-7** remove the role\n",
"info_help_text3":"Create a new queue or join an existing one: \n(level)+ / leave a queue: (level)- \n\nSubscribe to notifications when a queue is created: \n+ (level) / unsubscribe: - (level) \n\nExamples for DRS 9: \n9+ ← Create a queue (or join) \n9- ← leave a queue \n+9 ← subscribe",
"information":"Information",
"info_bot_delete_msg":"WARNING\n BOT DELETES USER MESSAGES AFTER 10 MINUTES.",
"info_bot_delete_msg_new":"WARNING\n BOT DELETES USER MESSAGES AFTER %d MINUTES.",
...
"you_subscribed_automated":"Bot has automatically subscribed %s to receive queue notifications for %s",
"queue":"Queue"}}`)
}
