...
//func (c *HsLogic) multiConnect(m models.IncomingMessage) bool {
//	if m.Text == "%соединить"|| m.Text=="join" {
//		defer func() {
//			if r := recover(); r != nil {
...
//		}()
//
//		fMA, err := c.db.DBv2.FindMultiAccountByUserId(m.NameId)
//		if err != nil {
//			c.log.ErrorErr(err)
//			return true
//		}
...
//	return false
//}
//func (c *HsLogic) newLink(m models.IncomingMessage, Gid uuid.UUID) {
...
//	}
//}
//func (c *HsLogic) migrationDataMultiUser(m models.IncomingMessage) {
//	defer func() {
//		if r := recover(); r != nil {
//			c.log.Info(fmt.Sprintf("recover() %+v", r))
//		}
