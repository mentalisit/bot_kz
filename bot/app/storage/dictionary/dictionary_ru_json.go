...
"info_help_text":"Встать в очередь *(уровень КЗ)+(время ожидания)*:\n    **[3-11]+** или\n    **[3-11]+[указать время ожидания в минутах]**\n*Примеры:*\n    **7+** встать в очередь на КЗ 7 ур.\n    **8+30** встать в очередь на КЗ 8 ур., время ожидания не более 30 минут.\nПокинуть очередь:\n    **[3-11]-**\n*Пример:*\n    **9-** выйти из очереди КЗ 9 ур.\nПосмотреть список активных очередей:\n    **о[3-11]**\n*Пример:*\n    **о9** вывод очереди для вашей КЗ\nПолучить роль КЗ:\n    **+[3-11]**\n*Примеры:*\n    **+6** получить роль КЗ 6 ур.\n    **-6** снять роль \nДля Тёмных Красных Звезд\nДля старта очереди\n    **7*** или **d7+**\nПокинуть очередь:\n    **d7-**\nДля получения роли:\n    **+d7**",
"information":"Справка",
